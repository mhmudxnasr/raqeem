      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <div className="space-y-6">
          <Card className="space-y-4">
            ...
            <p className="font-mono text-4xl text-[#F0F0F0]">{formatAmount(totalFunded, 'USD')}</p>
            <p className="text-sm text-[#A0A0A0]">Current net worth is {formatAmount(calculateNetWorthCents(snapshot), 'USD')}.</p>
          </Card>
        </div>
      </div>
    </>
